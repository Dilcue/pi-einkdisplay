...
_TEMP_FONT  = load_font(str(settings.fonts_dir / "notkia.ttf"), 52)
_COND_FONT  = load_font(str(settings.fonts_dir / "notkia.ttf"), 18)
_GLYPH_FONT = load_font(str(settings.fonts_dir / "icons.ttf"), 96)
